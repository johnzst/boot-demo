package com.example.bootDemo.common.utils;
...
public class ListUtils {
    ...
    public static <key, value> Map<value, key> toMapRevert(List<value> data, SelectFunc<value, key> func) {
        Map<value, key> map = new HashMap<>();
        for (value t : data) {
            key value = func.select(t);
            map.put(t, value);
        }
        return map;
    }
